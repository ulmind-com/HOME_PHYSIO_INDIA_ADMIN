...
export const videosConfig: ResourceConfig<Video> = {
  ...
  fields: [
    ...
    { name: "video_file", label: "Video File", type: "video", folder: "home-physio-india/videos", section: "Media", helper: "Upload a video when Source is Cloudinary" },
    { name: "thumbnail", label: "Thumbnail", type: "image", folder: "home-physio-india/videos", section: "Media" },
...
export const testimonialsConfig: ResourceConfig<Testimonial> = {
  ...
  fields: [
    ...
    { name: "photo", label: "Photo", type: "image", folder: "home-physio-india/testimonials", section: "Media" },
    { name: "is_featured", label: "Featured", type: "switch", section: "Visibility" },
    { name: "is_active", label: "Active", type: "switch", defaultValue: true, section: "Visibility" },
    { name: "order", label: "Order", type: "number", defaultValue: 0, section: "Visibility" },
  ],
